...
export function FileTreeNode({ node, onSelect, onContextMenu, depth }: FileTreeNodeProps) {
  ...
  return (
    <div>
      <div
        className="flex items-center gap-1 py-1 cursor-pointer hover:bg-white/5 text-[13px] group relative"
      ...
      >
        ...
        {node.isDir ? (
          <span className="w-5 flex items-center justify-center text-[10px] text-text-muted shrink-0">
            {loading ? (
        ...
        <span className="w-5 flex items-center justify-center shrink-0">
          {node.isDir ? (
            expanded
              ? <svg className="w-4 h-4 text-accent-light" viewBox="0 0 24 24" fill="currentColor"><path d="M2 6a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1H2V6z"/><path d="M2 10h20v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8z"/></svg>
              : <svg className="w-4 h-4 text-text-muted" viewBox="0 0 24 24" fill="currentColor"><path d="M2 6a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1H2V6z"/><path d="M2 10h20v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8z"/></svg>
          ) : (
